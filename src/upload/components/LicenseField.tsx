...
export const ALL_OPTIONS: Option[] = [
  {
    ...
    note: `Універсальний вибір для більшості документів, яким понад 120 років`,
    sort: 1
  },
  {
  ...
  },
  {
    ...
    note: `Зазвичай використовується для Російської імперії ${THRESHOLD_120}-1917 років`,
    sort: 5
  },
  {
    ...
    цієї дати.`,
    note: `Зазвичай використовується для УНР та УРСР 1917-${THRESHOLD_70-1} років`,
    sort: 3
  },
  {
...
export default function LicenseField({ dateState, author, value: rawValue, onChange, manuallySet, onSetManual, disabled }: Props) {
  ...
  return (
    <Listbox value={value} onChange={(v: string[]) => { onSetManual(true); onChange(sortByOptionOrder(v)); }} multiple disabled={disabled}>
      <Listbox.Button
